...
void helper_for_help::get_help_file() {
    ...
    std::cout << "ls - displaying a list of files or folders in current path"
...
void helper_for_help::get_help_console() {
    std::cout << "[------HELP CONSOLE]------]" << std::endl;
...
void helper_for_help::get_help_full() {
    std::cout << std::endl;
    std::cout << "[------HELP ALL COMMANDS]------]" << std::endl;
